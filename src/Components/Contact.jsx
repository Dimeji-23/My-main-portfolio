    ...
    >
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1 text-sm text-gray-400 border border-neutral-800 rounded-full mb-4">
            Contact
          </span>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 md:p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-black border border-white text-white py-3 rounded-lg font-medium hover:bg-white hover:text-black transition disabled:opacity-50 flex items-center justify-center gap-2"
            >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <a
              href="mailto:sulaymanmuhammed2019@gmail.com"
